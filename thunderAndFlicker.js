...
function timerIncrement() {
    ...
    if (idleTime > 0) {
        ...
        setTimeout(function(){document.body.style.backgroundColor = '#FFFFFF'},50);
        setTimeout(function(){document.body.style.backgroundColor = '#000000'},90);
        setTimeout(function(){document.body.style.backgroundColor = '#FFFFFF'},130);
        setTimeout(function(){document.body.style.backgroundColor = '#000000'},170);
		setTimeout(function(){document.body.style.backgroundColor = '#FFFFFF'},210);
        setTimeout(function(){document.body.style.backgroundColor = '#000000'},250);
		setTimeout(function(){document.body.style.backgroundColor = '#FFFFFF'},700);
        setTimeout(function(){document.body.style.backgroundColor = '#000000'},710);
		setTimeout(function(){document.body.style.backgroundColor = '#FFFFFF'},730);
        setTimeout(function(){document.body.style.backgroundColor = '#000000'},740);
    }
}
