...
no_options[2] = "RUN";
failArray[1] = "You run at it, swinging your fists. It stops you with ease with a swing of the sharpened axe. The last thing you see is red on silver. This is the end of your story.";
failArray[2] = "You attempt to run and hear a whoosh. The axe tears through the upper section of your spine. You can feel your shoulder blades separating. This is the end of your story.";
...
no_options[3] = "RUN";
failArray[3] = "You attempt to run and hear a whoosh. The axe tears through the upper section of your spine. You can feel your shoulder blades separating. This is the end of your story.";
...
failArray[4] = "You stand on the porch with an axe and a hatchet. A couple minutes pass and several large men with a various assortment of weapons arrive at the porch. You attempt to fight them off, regretting not having climbed through a window, but there are too many. You can't tell you if it was blades or bludgeoning that kill you. This is the end of your story."
...
failArray[5] = "You stand on the porch with an axe and a hatchet. A couple minutes pass and several large men with a various assortment of weapons arrive at the porch. You attempt to fight them off, regretting not having climbed through a window, but there are too many. You can't tell you if it is blades or bludgeoning that kill you. This is the end of your story.";
...
failArray[6] = "You bravely open the door that leads to the noise. The mystery is instantly solved. There stands a man holding a large shotgun. He wastes no time in taking aim at your body. Not that aim matters with a gun like that. You quickly throw your hatchet at him. He moves to the left but your hatchet cuts his thigh. It delays the shooter slightly but doesn't stop him. POW! The shot tears through your midsection. This is the end of your story.";
...
failArray[7] = "You open the door. Despite your attempts to be quiet, it creaks loudly. You hear shouting and heavy footsteps. The man with the shotgun appears and before you can defend yourself, he blows your face off with a double-barreled blast. This is the end of your story.";
...
failArray[10] = "You leave the woman and re-enter the hallway you came from. You walk right into a large man. He grins and then everything goes black. The last thing you feel is explosive pain on the top of your head. This is the end of your story.";
...
failArray[11] = "A man bursts into the room. He has what appears to be a red priest\'s robe on and holds a large pistol in his hand. Jessica is near him. He doesn't notice her. She jumps on his back. He aims his gun at you and pulls the trigger. This is the end of your story.";
...
failArray[12] = "A man bursts into the room. He has what appears to be a red priest\'s robe on and holds a large pistol. Jessica is near him. He doesn\'t notice her. She jumps on his back. He aims his gun at you and pulls the trigger. This is the end of your story.";
...
failArray[13] = "You run toward the man. Jessica jumps on his back. He struggles and aims his gun at you. He pulls the trigger. This is the end of your story.";
...
failArray[14] = "You and Jessica go out the door. In the hallway is a crowd of men, wearing similar red robes as the man with the pistol. You immediately begin firing your pistol but there is a problem: they have guns too. This is the end of your story.";
...
failArray[15] = "You call Jessica over. You walk over to the books, then pick one up. It's then you realize that the book just triggered the spikes. Faster than you can react, the spikes fall from the ceiling. You and Jessica are impaled from above. This is the end of your story.";
...
failArray[16] = "You walk over to the books. You pick one up. It's then you realize that the book just triggered the spikes. Faster than you can react, the spikes fall from the ceiling. You and Jessica are impaled from above. This is the end of your story.";
...
failArray[17] = "You head back toward the staircase you came in on. You get to the top of the stairs and begin walking down. A man bursts through the door at the bottom of the staircase and shoots at you. You catch three bullets and see Jessica go down as well. This is the end of your story.";
...
failArray[18] = "You run toward the door and are shot in the back. You see Jessica go down as well, a bullet tearing through her head. You feel an unbearable pain and burning in your lower back. You grab a book. The spikes swing down. You figure if you're going, you're taking them with you. This is the end of your story.";
...
failArray[19] = "You pull out your pistol and methodically shoot the three of them. Boom, boom, boom. Three head shots. You hear a bang from behind and turn just as you feel a crushing blow on the left side of my head. You can't make out your attacker. This is the end of your story.";
...
failArray[20] = "You pull out your pistol and methodically shoot the three of them. Boom, boom, boom. Three head shots. You hear a bang from behind and turn just as you feel a crushing blow on the left side of my head. You can't make out your attacker. This is the end of your story.";
...
failArray[23] = "You walk over to the fence and grip the bars. |\"Are you sure that\'s a good idea?\" Jessica asks. She eyes the spikes at the top. |\"I\'m a good climber,\" you reply. \"I\'ll figure something out.\" |\"Okay,\" she says. \"But I can\'t climb it, so what happens when you get over?\" |\"I said I\'d figure it out!\" you snap back. |You hand her your pistol and begin making your way up the fence. The bars are slightly rusted, which help your grip. You make it to the top, sweating and out of breath. You reach over the spikes and pull. You slip and fall forward. You hear Jessica yell and then feel the rusted spikes impale your throat and upper body. This is the end of your story.";
...
failArray[28] = "You take your axe, smash open the closet doors and charge at him. He makes an attempt to stab you but you dodge and bring your axe down on his head. Two more men enter the room. Before you can react they shoot you in the back. This is the end of your story.";
...
failArray[29] = "You ready your gun, open the door and open fire on the three men. Bam! One down. Bam! Another down. The third one has made his way close to you and grabs for the gun. There is a struggle. He is twice your size and overpowers you. Bam! A shot goes off. You hear a noise. Jessica has fallen to the ground, blood gushing out of her head. And then... Bam! This is the end of your story.";
...
failArray[31] = "Because you can't find a way through, you leave the room the way you came in. It seems the three men you saw earlier on the security displays have caught up with you. Jessica jumps in front of you swinging her hatchet. She doesn\'t stand a chance. The last thing you see is the barrel of a gun. This is the end of your story.";
...
failArray[32] = "You reach down and open the lid. There is a bright flash and an explosion. You briefly feel your flesh burning, then you think of Jessica...This is the end of your story.";
...
failArray[33] = "You reach down and open the lid. There is a bright flash and an explosion. You briefly feel your flesh burning, then you think of Jessica...This is the end of your story.";
...
failArray[34] = "You reach down and open the lid. There is a bright flash and an explosion. You briefly feel your flesh burning, then you think of Jessica...This is the end of your story.";
...
no_options[52] = "TALK";
failArray[36] = "\"What is happen-\" you start. |The man moves quickly and his cleaver strikes you in the side of the head. The first blow knocks you down. You attempt to raise your weapon but your arm won\'t move. He strikes you again. This is the end of your story.";
...
no_options[53] = "TALK";
failArray[37] = "\"What is happen-\" you start. |The man moves quickly and his cleaver strikes you in the side of the head. The first blow knocks you down. You attempt to raise your weapon but your arm won\'t move. He strikes you again. This is the end of your story.";
...
failArray[38] = "You pull the trigger. Bam! He dodges to the left and you miss! You attempt another shot but he is upon you. His knife slides deep into your right eye. The pain is deathly. You see red. This is the end of your story.";
...
failArray[39] = "You figure he is insane and continue past him. You hear a rapid shuffling and feel a sharp sting in the back of your neck. The stinging becomes an unbearable pain. You cough blood. The man has stabbed you in the back of the neck. This is the end of your story.";
...
failArray[42] = "You shoot at the beast with your gun. The shots seem to have no effect on the creature. It charges at you. You look over to see the men attacking Jessica. You try to stab the beast but it easily overpowers you. You die knowing how it feels to be eaten alive. This is the end of your story.";
...
failArray[43] = "You shoot at the beast with your gun. The shots seem to have no effect on the creature. It charges at you. You look over to see the men attacking Jessica. You try to stab the beast but it easily overpowers you. You die knowing how it feels to be eaten alive. This is the end of your story.";
...
failArray[44] = "You run for the fence. Behind you, the man aims his rifle. You were hoping that due to his obviously deranged mental state he\'d be a poor shot. You were wrong. You hear the crack just as a bullet blows through the back of your head. This is the end of your story.";
...
failArray[45] = "You run for the fence. Behind you, the man aims his rifle. You were hoping that due to his obviously deranged mental state he\'d be a poor shot. You were wrong. You hear the crack just as a bullet blows through the back of your head. This is the end of your story.";
...
failArray[47] = "You grip your axe and run toward the men. One of them sidesteps and punches you in the side of your face. You are dazed and drop your axe. You reach down to pick up your weapon and feel another blow on the back of your head. You collapse next to the group. The men proceed to kick your head in. This is the end of your story.";
...
function introduction (name) {
    ...
    if (save_point != null) {
        ...
        dramatic_parse(false,-1,"My name is " +name+ ". The choices you make will determine whether you live or die. \nDo you dare to start this horrific journey?",function() {
            single_callback = false;
