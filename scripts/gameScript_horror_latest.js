...
*/
instructionArray[12] = "\"No, I shouldn\'t start a fire,\" I thought as I walked forward. First I heard a lock click at the end of the hallway and then I heard a shrill scream. It sounded like a woman yelling from behind the door. \"Help! He\'s going to kill me!\"||";
...
function story_mode (story_cursor) {
    ...
    dramatic_parse(false,story_cursor,instructionArray[story_cursor],function() {
		...
		$("#instructions2").append("WHAT DID I DO?");
